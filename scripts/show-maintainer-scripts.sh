...
if is_deb_pkg; then
    if [ -e debian/*preinst ]; then echo "preinst:" && cat debian/*preinst && echo; fi
    if [ -e debian/*prerm ]; then echo "prerm:" && cat debian/*prerm && echo; fi
    if [ -e debian/*postinst ]; then echo "postinst:" && cat debian/*postinst && echo; fi
    if [ -e debian/*postrm ]; then echo "postrm:" && cat debian/*postrm && echo; fi
fi
